...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="{{ asset('vendor/admin/assets/imgs/template/favicon.svg') }}">
  <link href="{{ asset('vendor/admin/assets/css/style.css?version=4.1') }}>" rel="stylesheet">
...
<body class="@yield('body_class')">
  ...
  <script src="{{asset('vendor/admin/assets/js/vendor/bootstrap.bundle.min.js') }}"></script>
  <script src="{{asset('vendor/admin/assets/js/plugins/waypoints.js') }}"></script>
  <script src="{{asset('vendor/admin/assets/js/plugins/wow.js') }}"></script>
  <script src="{{asset('vendor/admin/assets/js/plugins/magnific-popup.js') }}"></script>
  <script src="{{asset('vendor/admin/assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
  <script src="{{asset('vendor/admin/assets/js/plugins/select2.min.js') }}"></script>
  <script src="{{asset('vendor/admin/assets/js/plugins/isotope.js') }}"></script>
